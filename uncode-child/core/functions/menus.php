...
if (!class_exists('unmenu')) {
	class unmenu {
		...
		function __construct($type, $param)
		{
			...
			/* load custom logo for template-home.php */
				if ( is_page_template('template-home.php') ) {
					$LOGO->logo_id = array('105826'); // prod 105874  dev 105826
					$LOGO->logo_mobile_id = array('105826'); // prod 105874  dev 105826
					$logo_height = 40;
					$logo_height_mobile = 40;
				}
			/* end load custom logo for template-home.php */
